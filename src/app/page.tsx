              ...
              <div className="mx-auto w-full max-w-lg">
                ...
                <div className="flex-col items-center justify-center">
                  <div className="flex py-5">
                    ...
                    <Switch className="ml-auto" checked={useTools} onCheckedChange={(checked) => {
                      setUseTools(checked);
                    }}/>
                  </div>
                  ...
                  <div className="flex py-5">
                    ...
                    <Switch className="ml-auto" checked={toolStatus.web_search} disabled={!useTools} onCheckedChange={(checked) => {
                  ...
                  <div className="flex py-5">
                    ...
                    <Switch className="ml-auto" checked={toolStatus.wolfram_alpha} disabled={!useTools} onCheckedChange={(checked) => {
                      setToolStatus({...toolStatus, wolfram_alpha: checked});
                    }}/>
                  </div>
                  <div className="flex py-5">
                    <Label htmlFor="pubmed-search" className="w-1/2 px-2.5">PubMed</Label>
                    <Switch className="ml-auto" checked={toolStatus.pubmed_search} disabled={!useTools} onCheckedChange={(checked) => {
