...
export async function pubMedSearch(
  ...
  if (category.toLowerCase() == "therapy")
    parsed_query += " AND Therapy/Broad[filter]";
  else if (category.toLowerCase() == "diagnosis")
    parsed_query += " AND Diagnosis/Broad[filter]";
  else if (category.toLowerCase() == "etiology")
    parsed_query += " AND Etiology/Broad[filter]";
  else if (category.toLowerCase() == "prognosis")
    parsed_query += " AND Prognosis/Broad[filter]";
  else if (category.toLowerCase() == "clinical prediction guides")
    parsed_query += " AND Clinical Prediction Guides/Broad[filter]";
